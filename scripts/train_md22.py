...
def parse_args():
    ...
    parser.add_argument('--config_path', type=str, default=root_dir + '/config/md22.yml',
                        help='Path to config yaml file.')
    parser.add_argument('--molecule', type=str, default='md22_AT_AT', help='Molecule dataset to use.')
    ...
    parser.add_argument('--num_train', type=int, default=2500, help='Number of training samples.')
...
def load_config(config_path, args):
    ...
    if config.data.base_path is None:
        config.data.base_path = root_dir + '/data/md22'
